...
function DateValueEditor(
  ...
  function inputDate(digit: string) {
    ...
    // month: 1 以外なら即 next（例: 2,3,9 → 即確定）
    if (segKey === "month" && offset === 0 && digit !== "1") {
    ...
    // day: 4 以上なら即 completed（例: 4,5,9）
    if (segKey === "day" && offset === 0 && Number(digit) >= 4) {
